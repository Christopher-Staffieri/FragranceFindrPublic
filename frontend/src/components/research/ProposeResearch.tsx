...
export default function ProposeFragranceModal() {
  // State for form data
  const [formData, setFormData] = React.useState({
    ...
    fragrance_collection_other: "",
    parent_company: [] as object[],
    parent_company_other: "",
    gender: "",
    perfumers: [] as object[], // Only database perfumers
    perfumers_other: [] as object[], // Custom perfumers in separate field
    bottle_designer: [] as string[], // Only database designers
    ...
    varient_original_perfume: "", // Done
    is_limited: false, // Done
    limited_original_perfume: "", // Done
    is_collectors: false, // Done
    collectors_original_perfume: "", // Not Done
    interesting_facts: "", // Done
    additional_information: "", // Done
    youtube_link: "", // Done
  })
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setIsSubmitting(true)
    addResearch({perfume: formData.perfume, bottle_designer: bottleDesignerIds, bottle_designer_other: customBottleDesignerNames,
                brand: formData.brand.id, brand_other: formData.brand_other, fragrance_collection: formData.fragrance_collection.id,
                parent_company: formData.parent_company.id, parent_company_other: formData.parent_company_other, description: formData.description,
                ...
                youtube_link: formData.youtube_link, proposed_by: user.id, status: 'pending', pending: 1
    }).then((response) => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button
          size="default"
          className="bg-light-primary dark:bg-dark-primary text-white hover:bg-light-primary/90 dark:hover:bg-dark-primary/90 transition-all duration-300 shadow-lg hover:shadow-xl"
                      ...
                      <div className="grid gap-6">
                        ...
                        >
                          ...
                          <Input
                            ...
                            className="h-12 bg-light-surface dark:bg-dark-background border-2 border-light-border dark:border-dark-border focus-visible:ring-light-primary dark:focus-visible:ring-dark-primary rounded-lg dark:text-dark-text-primary"
                          />
                        </motion.div>
                            ...
                            <div className="relative">
                              ...
                              >
                                <Input
                                  ...
                                  className="border-0 bg-transparent pr-10 focus-visible:ring-0 dark:text-dark-text-primary"
                                />
                                <motion.div
