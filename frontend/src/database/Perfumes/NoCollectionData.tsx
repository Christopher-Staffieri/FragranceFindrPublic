...
export default function NoCollectionData({perfumeId, user, refreshData}){
    ...
    return(
        <section>  
           <div>
                {/* Instead of disabled change to a diff color than normal */}
                {currentlyOwnStatus ? <Button disabled onClick={() => handleClick('currently_own')}>Currently Own</Button> : <Button onClick={() => handleClick('currently_own')}>Currently Own</Button>}
                {ownedStatus ? <Button disabled onClick={() => handleClick('owned_before')}>Owned</Button> : <Button onClick={() => handleClick('owned_before')}>Owned</Button>}
                ...
                {/* <Button onClick={() => handleClick('wish')}></Button> */}
           </div>
        </section>
    )
}